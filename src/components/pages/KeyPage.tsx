...
export default function KeyPage({ keyId, dimension, initialContent = [] }: KeyPageProps) {
  ...
  return (
    <PageLayout accentColor={dimensionData.color}>
      ...
      {/* Curiosity Explorer Launch Card (only on ignited-curiosity) */}
      {keyId === 'ignited-curiosity' && (
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 bg-[#7A4DA4]/20">
                  <svg className="w-7 h-7 text-[#7A4DA4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* FlowZone CTA (only on optimized-tools) */}
      {keyId === 'optimized-tools' && (
        <section className="relative py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6">
            <Link
              href="/tools/flowzone"
              className="group block p-6 md:p-8 rounded-2xl border border-white/10 hover:border-[#6BA292]/40 bg-gradient-to-r from-[#6BA292]/10 to-transparent transition-all duration-300"
            >
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: '#6BA29220' }}>
                  <svg className="w-7 h-7 text-[#6BA292]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <p className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: '#6BA292' }}>Interactive Tool</p>
                ...
                <svg className="w-5 h-5 text-[#6BA292] opacity-50 group-hover:opacity-100 group-hover:translate-x-1 transition-all flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </div>
            </Link>
