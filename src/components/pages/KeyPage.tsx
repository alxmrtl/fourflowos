          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: '#6330A0' }}>Interactive Tool</p>
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: '#4E8C73' }}>Interactive Tool</p>
