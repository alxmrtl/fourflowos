  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        ...
        transition={{ duration: 5.0, repeat: Infinity, repeatType: 'loop', ease: [0.4, 0, 0.2, 1] }}
      />
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        ...
        transition={{ duration: 2.0, repeat: Infinity, repeatType: 'loop', ease: 'easeInOut' }}
      />
      {CONSUME_DOTS.map((dot, i) => (
        <motion.div
          ...
          transition={{ duration: 3.2, repeat: Infinity, repeatType: 'loop', ease: 'easeIn', delay: dot.delay, times: [0, 0.35, 0.7, 1] }}
        />
      ))}
    </div>
  );
