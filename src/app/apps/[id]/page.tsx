              ...
              <div className="flex flex-wrap items-center gap-4 mb-8">
                {app.platforms.includes('ios') && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-white text-ground font-semibold rounded-full hover:bg-gray-100 transition-colors"
                  >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <Link href="/privacy" className="text-spirit hover:text-[#9A6DC4] transition-colors text-sm font-medium">
                    Privacy Policy →
                  </Link>
                  <Link href="/terms" className="text-spirit hover:text-[#9A6DC4] transition-colors text-sm font-medium">
                    Terms of Service →
                  </Link>
                  <Link href="/support" className="text-spirit hover:text-[#9A6DC4] transition-colors text-sm font-medium">
                    Support →
                  </Link>
                </div>
              </div>
